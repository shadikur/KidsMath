...
public class KidsMathsDivision {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					KidsMathsDivision window = new KidsMathsDivision();
	...
	public float resultNum(int x, int y) {
		float ans = x / y;
		return ans;
	}
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				float resultValue = Float.parseFloat(enteredValue);
