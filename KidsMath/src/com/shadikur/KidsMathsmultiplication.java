...
public class KidsMathsmultiplication {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					KidsMathsmultiplication window = new KidsMathsmultiplication();
	 ...
	 */
	public KidsMathsmultiplication() {
		initialize();
	}
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if ( resultValue == resultNum(num1, num2)) {
					newNum();
					lblNewLabel_3.setText(num1 + " x " + num2 + " = ?");
					rightAns++;
					totalSolved++;
